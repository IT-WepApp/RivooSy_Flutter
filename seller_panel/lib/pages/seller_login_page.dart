  ...
  Future<void> _login() async {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        // بعد تسجيل الدخول، نتحقق من الصلاحيات
        ...
        if (e.code == 'user-not-found') {
          errorMessage = 'Seller email not found.';
        } else if (e.code == 'wrong-password') {
          errorMessage = 'Incorrect seller password.';
        } else {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // Image.asset('assets/images/seller_logo.png', height: 100),
