...
class _StoreDetailsPageState extends State<StoreDetailsPage> {
  ...
  void initState() {
    super.initState();
    _storeDetailsFuture = StoreService().getStoreDetails(widget.storeId);
  }
            ...
            if (products == null || products.isEmpty) {
              return  Center(
                  child: Column(
                      ...
                      children: [
                        Text(storeData['name'] as String? ?? 'Store Name Not Available', style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
                ...
                slivers: <Widget>[
                  SliverAppBar(
                      ...
                      flexibleSpace: FlexibleSpaceBar(
                        centerTitle: false,
                        title: Text(storeData['name'] as String? ?? 'Store Name Not Available',
